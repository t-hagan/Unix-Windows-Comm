...
class XPCLoanCalc
{
        ...
        // Holds the amortization schedule
        ...
        int iRetrieveRate();
public:
        // The constructor.  Initializes private member variables and loads the bank
        // database.
        ...
        // Return a payment
        ssinglepayment getListofPayments(int _iPayment) { return listofpayments[_iPayment]; }
};
