...
main()
{
    pid_t pid;
    int i;
    int mode = RPC_SVC_MT_AUTO;    // Set the mode to be auto threads
    int max = 20;            // Set the maximum number of threads to be 20

    (void) sigset(SIGPIPE, SIG_IGN);

    /* Set the multi-threaded mode of the server to auto threads */
    ...
    /* Set the maximum number of threads to 20 */
