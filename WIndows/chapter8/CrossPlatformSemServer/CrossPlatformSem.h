...
_RPCAPI extern retvalstruct *createsem_1(semstruct *);
#define closesem ((u_long)2)
_RPCAPI extern retvalstruct *closesem_1(semname *);
#define removesem ((u_long)3)
_RPCAPI extern retvalstruct *removesem_1(semname *);
#define lockwait ((u_long)4)
_RPCAPI extern retvalstruct *lockwait_1(semname *);
#define locknowait ((u_long)5)
_RPCAPI extern retvalstruct *locknowait_1(semname *);
#define unlock ((u_long)6)
_RPCAPI extern retvalstruct *unlock_1(semname *);
#define getvalue ((u_long)7)
_RPCAPI extern retvalstruct *getvalue_1(semname *);
